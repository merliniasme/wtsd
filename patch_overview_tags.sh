...
# Insert the tags section before the closing </section> of the Database Overview
sed -i '/<span className="text-xs text-slate-400">Total Pairs<\/span>/!b;n;n;c\
        </div>\
        \
        {/* Pairs By Tag */}\
        <div className="pt-2">\
      ...
      </section>' src/components/SettingsView.tsx
